...
public interface UserBillRepository extends BillRepository {
    ...
    @Query("SELECT NEW com.example.be.base.user.model.response.UserBillResponse(b.id, b.code, SUM(db.quantity), (db.quantity * db.price) - COALESCE(v.discountAmount, 0), b.phoneNumber, b.createDate) " +
            "FROM Bill b " +
